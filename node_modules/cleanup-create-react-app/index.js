...
.then((answers) => {
  ...
  exec(`echo "import React from 'react'; import ReactDOM from 'react-dom';  import App from './App'; ReactDOM.render(<App />, document.getElementById('root'));" > ${process.cwd()}/src/index.js && echo "import React, { Component } from 'react';  class App extends Component {  render() {     return (       <h1>Hello World</h1>     );   }  }  export default App;" > ${process.cwd()}/src/App.js`, {cwd: __dirname},(err, stdout, stderr)=>{
    if (err) {
      console.error(err);
    } else {
